...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=JALIL\\SQLEXPRESS;Database=TravelExperts;Trusted_Connection=True;TrustServerCertificate=true;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<WalletTransaction>(entity =>
        {
            ...
            entity.Property(e => e.Amount)
                  ...
                  .IsRequired();
            entity.HasOne(e => e.Customer) // Define the relationship
                  .WithMany(c => c.WalletTransactions) // Customer has many WalletTransactions
                  .HasForeignKey(e => e.CustomerId); // Foreign key in WalletTransaction
        });
        ...
        modelBuilder.Entity<AgentPassword>(entity =>
        {
            ...
            entity.HasOne(d => d.Agent).WithOne(p => p.AgentPassword)
                .HasForeignKey<AgentPassword>(d => d.AgentId)
        ...
        modelBuilder.Entity<PackagesProductsSupplier>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.PackageId, e.ProductSupplierId }, "UQ__Packages__29CA8E9507CBFE69").IsUnique();
